    ...
    <>
        ...
        <main className='w-full flex h-dvh justify-center items-center' id='home'>
            <div className='flex flex-col items-center p-1 gap-4 w-full max-w-[1440px]  '>
                ...
                <a href="#projects" className=' w-full block text-center ' > <button className='bg-ctaColor text-white w-full max-w-[200px] xl:max-w-[250px] py-2 rounded-md mt-5 uppercase hover:bg-ctaHover transition-all'>projects</button></a>
            </div>
        </main>
